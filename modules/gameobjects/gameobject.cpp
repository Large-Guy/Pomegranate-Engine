...
GameObject::~GameObject() {
    ...
    gameObjectsByName[name].erase(std::remove(gameObjectsByName[name].begin(), gameObjectsByName[name].end(), this), gameObjectsByName[name].end());
...
void GameObject::setName(const std::string &name) {
    gameObjectsByName[this->name].erase(std::remove(gameObjectsByName[name].begin(), gameObjectsByName[name].end(), this), gameObjectsByName[name].end());
    this->name = name;
    gameObjectsByName[name].push_back(this);
}
