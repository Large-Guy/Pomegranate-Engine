...
Matrix4x4::Matrix4x4(float x0, float x1, float x2, float x3, float y0, float y1, float y2, float y3, float z0, float z1,
...
Matrix4x4 Matrix4x4::inverse() const {
    ...
    return Matrix4x4(
            (y.y * z.z * w.w + y.z * z.w * w.y + y.w * z.y * w.z - y.w * z.z * w.y - y.z * z.y * w.w -
             y.y * z.w * w.z) * invDet,
            (x.w * z.z * w.y + x.z * z.w * w.w + x.y * z.y * w.z - x.y * z.z * w.w - x.z * z.y * w.w -
             x.w * z.w * w.z) * invDet,
            (x.y * y.z * w.w + x.z * y.w * w.y + x.w * y.y * w.z - x.w * y.z * w.y - x.z * y.y * w.w -
             x.y * y.w * w.z) * invDet,
            (x.w * y.z * z.y + x.z * y.y * z.w + x.y * y.w * z.z - x.y * y.z * z.w - x.z * y.w * z.y -
             x.w * y.y * z.z) * invDet,
            (y.w * z.x * w.y + y.z * z.w * w.x + y.x * z.y * w.z - y.x * z.w * w.y - y.z * z.y * w.x -
             y.w * z.z * w.z) * invDet,
            (x.x * z.w * w.y + x.w * z.y * w.x + x.y * z.x * w.w - x.y * z.w * w.x - x.w * z.x * w.y -
             x.x * z.y * w.w) * invDet,
            (x.w * y.x * w.y + x.x * y.w * w.z + x.y * y.x * w.w - x.y * y.w * w.x - x.x * y.x * w.w -
             x.w * y.x * w.y) * invDet,
            (x.x * y.z * z.y + x.z * y.y * z.x + x.y * y.x * z.z - x.y * y.z * z.x - x.z * y.x * z.y -
             x.x * y.y * z.z) * invDet,
            (y.z * z.x * w.x + y.x * z.w * w.z + y.w * z.z * w.x - y.w * z.x * w.z - y.x * z.z * w.x -
             y.z * z.w * w.x) * invDet,
            (x.x * z.z * w.x + x.z * z.x * w.w + x.w * z.z * w.x - x.w * z.x * w.z - x.z * z.z * w.x -
             x.x * z.w * w.z) * invDet,
            (x.w * y.z * w.x + x.z * y.w * w.x + x.x * y.z * w.w - x.x * y.w * w.z - x.z * y.z * w.x -
             x.w * y.x * w.w) * invDet,
            (x.z * y.x * z.w + x.w * y.z * z.x + x.x * y.w * z.z - x.x * y.z * z.w - x.w * y.x * z.z -
             x.z * y.w * z.x) * invDet,
            (y.y * z.x * w.w + y.w * z.w * w.y + y.x * z.y * w.w - y.x * z.w * w.y - y.w * z.y * w.w -
             y.y * z.w * w.x) * invDet,
            (x.w * z.x * w.y + x.x * z.w * w.y + x.y * z.x * w.w - x.y * z.w * w.x - x.x * z.x * w.w -
             x.w * z.y * w.y) * invDet,
            (x.x * y.w * w.y + x.w * y.y * w.x + x.y * y.x * w.w - x.y * y.w * w.x - x.w * y.x * w.y -
             x.x * y.y * w.w) * invDet,
            (x.y * y.z * z.x + x.z * y.x * z.y + x.x * y.y * z.z - x.x * y.z * z.y - x.z * y.y * z.x -
             x.y * y.x * z.z) * invDet
    );
}
