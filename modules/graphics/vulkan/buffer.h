...
protected:
    ...
    createBuffer(VkDeviceSize size, VkBufferUsageFlagBits usage, VkMemoryPropertyFlags properties, VkBuffer& buffer,
        ...
        Debug::AssertIf::isFalse(
                vkAllocateMemory(Graphics::getInstance()->_logicalDevice, &allocInfo, nullptr, &bufferMemory) ==
                VK_SUCCESS, "Failed to allocate buffer memory!");
    ...
    void copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
        ...
        vkFreeCommandBuffers(Graphics::getInstance()->_logicalDevice, Graphics::getInstance()->_commandPool, 1,
                             &commandBuffer);
    }
...
private:
    ...
    void generateBuffer() {
        ...
        BufferBase<Type>::createBuffer(bufferSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT,
        ...
        BufferBase<Type>::createBuffer(bufferSize, (VkBufferUsageFlagBits) (VK_BUFFER_USAGE_TRANSFER_DST_BIT),
                                       VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, this->_buffer, this->_memory);
